...
2. Render in local mode with deterministic preinstall setup.
3. Inspect generated MP4/GIF for readability and narrative clarity.

## Command Set
```bash
studio validate screenplays/agent_generated_feature_flag_fix.yaml --explain
studio run screenplays/agent_generated_feature_flag_fix.yaml --local --output-dir outputs
```
